...
#data = data[0:1000]
data = data[data['MAG_AUTO_G_DERED'] < 24.]
...
left = figure(tools=TOOLS_LEFT, plot_width=500, plot_height=500, 
...
right = figure(tools=TOOLS_RIGHT, plot_width=500, plot_height=500, title='CMD')
right.circle('x1', 'y1', hover_color="firebrick", source=source)
right.x_range = Range1d(-0.5, 2.5)
right.y_range = Range1d(24., 16.)
